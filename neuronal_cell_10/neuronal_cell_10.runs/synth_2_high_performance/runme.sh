...
HD_PWD='C:/Users/David/Desktop/TFG VHDL versiones/23_12_2020/neuronal_cell_10/neuronal_cell_10.runs/synth_2_high_performance'
cd "$HD_PWD"
...
EAStep vivado -log neuronal_cell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neuronal_cell.tcl
