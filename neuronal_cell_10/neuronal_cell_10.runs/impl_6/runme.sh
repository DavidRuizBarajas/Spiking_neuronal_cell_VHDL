...
HD_PWD='C:/Users/David/Desktop/TFG VHDL versiones/23_12_2020/neuronal_cell_10/neuronal_cell_10.runs/impl_6'
cd "$HD_PWD"
...
EAStep vivado -log neuronal_cell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neuronal_cell.tcl -notrace
