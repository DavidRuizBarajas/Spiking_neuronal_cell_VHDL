...
HD_PWD='C:/Users/David/Desktop/TFG VHDL versiones/23_12_2020/red_neuronal_pulsante/red_neuronal_pulsante.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log spiking_Web.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spiking_Web.tcl
