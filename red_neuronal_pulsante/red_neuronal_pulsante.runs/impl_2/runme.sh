...
HD_PWD='C:/Users/David/Desktop/TFG VHDL versiones/23_12_2020/red_neuronal_pulsante/red_neuronal_pulsante.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log spiking_Web.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spiking_Web.tcl -notrace
