...
-- IMPORTANTE: este archivo se modifico para poner pesos todos a 1 para cualquier tipo de estructura de la red neuronal
--si no da error de compilacion por que le faltan valores si se pone de mas o de menos entradas
----------------------------------------------------------------------------------
library IEEE;
...
--memorias reset --los valores van desde el N-1 A 0 (orden de las posiciones)
    pesos<=(others=>1); --valor por defecto para probar sin tener que configurar
